        ...
        <VStack gap='16'>
            ...
            <VStack gap='32' max>
                ...
                <HStack gap='32'>
                    ...
                    <HistoryGsap id='4item_90rad' radius={83} pointCount={4} titles={mockTitle4El}/>
                    <HistoryGsap id='5item_90rad' radius={83} pointCount={5} titles={mockTitle5El}/>
                ...
                <HStack gap='32'>
                    ...
                    <HistoryGsap id='3item_angles' radius={83} pointCount={3} numberVisibility={true} extraRotation={45}/>
                    <HistoryGsap id='4item_angles' radius={83} pointCount={4} numberVisibility={true} extraRotation={89}/>
                ...
                <HStack gap='32'>
                    <VStack gap='32'>
                        ...
                        <HStack gap='32'>
                            ...
                            <HistoryGsap id='6item_duration04' radius={108} pointCount={6} numberVisibility={true} duration={0.4} titles={mockTitle6El}/>
                            <HistoryGsap id='2item_duration2' radius={108} pointCount={2} numberVisibility={true} duration={2} titles={mockTitle2El}/>
                            <HistoryGsap id='6item_duration2' radius={108} pointCount={6} numberVisibility={true} duration={2} titles={mockTitle6El}/>
                        </HStack>
                    </VStack>
                </HStack>
                <VStack gap='8' max>
